    ...
    [
        ...
        dbc.Row(
            [
                ...
                dbc.Col([html.Br(), dbc.Button("Submit", id="submit-met-exp-browser", className="button-interact")]),
            ],
        ),
        html.Br(),
        dbc.Row(
        ...
        dbc.Row(
            dbc.Collapse(
                dbc.Card(
                    dbc.CardBody(html.P(id="msg-met-exp-browser")),
                    color="danger",
                    outline=True,
                ),
