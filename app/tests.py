...
def test_load_1d_exp():
    ...
    assert frame.empty == False, "Loaded frame is empty"
    ...
    assert frame.isna().sum().any() == False, "Frame contains NaNs."
...
def test_load_1d_negative():
    ...
    fo.sample_types = st
    frame, status = fo.load_1d("XXX")
    assert frame.empty == True, "Loaded frame is not empty."
    assert frame.isna().sum().any() == False, "Frame contains NaNs."
...
def test_load_many_mvf_exp():
    ...
    assert frame_1.isna().sum().any() == False, "Frame 1 contains NaNs."
    assert frame_2.isna().sum().any() == False, "Frame 2 contains NaNs."
...
def test_load_met_exp_frame_neg():
    ...
    assert frame.empty == True, "Frame should be empty."
